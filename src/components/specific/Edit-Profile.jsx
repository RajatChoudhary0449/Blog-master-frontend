...
function EditProfile() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        let res;
        try {
            res = await apiInstance.get(`user/profile/${userId}/`);
        }
        catch (error) {
            console.log(error);
        }
                                    ...
                                    <div>
                                        ...
                                        <div className="row gx-3">
                                            ...
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <textarea onChange={handleProfileChange} name="about" id="about" cols="30" value={profileData?.about !== "null" ? profileData?.about : ""} rows="5" className="form-control"></textarea>
                                            </div>
                                            {/* Bio */}
                                            <div className="mb-3 col-12 col-md-12">
